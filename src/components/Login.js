    ...
    <>
      <div className="w-full max-w-md p-4 rounded-md shadow sm:p-8 dark:bg-gray-900 dark:text-gray-100">
        ...
        <form className="space-y-8 ng-untouched ng-pristine ng-valid">
          ...
          <button type="button" className="w-full px-8 py-3 font-semibold rounded-md dark:bg-violet-400 dark:text-gray-900">LOG IN</button>
        </form>
        ...
        <p className="text-xs text-center sm:px-6 dark:text-gray-400">Don't have an account?
          <a href="/signup" className="underline dark:text-gray-100"> Sign up</a>
        </p>
